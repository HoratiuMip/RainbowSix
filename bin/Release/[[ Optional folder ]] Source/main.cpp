...
int main() {
    ...
    std :: deque< Sound > snds;

    Audio audio{ Audio :: devices()[ 0 ], 44100, 1, 32, 256 };

    snds.emplace_back( audio, "Stuff\\gold.wav" );
    snds.emplace_back( audio, "Stuff\\song.wav" );
    snds.emplace_back( audio, "Stuff\\boop.wav" );
